import { ProjectProvider, EditorProvider, SettingsProvider } from './contexts';
...
function AppContent() {
  ...
  if (!window.crossOriginIsolated) {
    return (
      <div className="h-screen w-screen bg-[var(--kiri-bg)] flex flex-col items-center justify-center text-center px-6">
        <div className="max-w-md p-8 bg-[var(--kiri-surface)] border border-[var(--kiri-border)] rounded-xl shadow-2xl">
          ...
          <p className="text-sm text-[var(--kiri-muted)] mb-6 leading-relaxed">
